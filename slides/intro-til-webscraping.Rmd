...
1. Sjekk ut objektene `rr_resp_1` og `rr_resp_2` i ditt arbeidsmiljø. Hva er forskjellen på de to objektene? 
2. Hvilken nettside / url stammer de fra?
...
- For å kunne bruke Selenium trenger vi en driver denne kan kjøre på. 
