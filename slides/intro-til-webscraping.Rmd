...
5. Legg til attributtet `data-tabell` med verdien `befolkning` til det andre `<table>`-elementet
...
* Pakken inneholder flere funksjoner for å velge elementer (noder) og trekke ut innhold
...
## Forutsetninger for bruk av funksjoner
