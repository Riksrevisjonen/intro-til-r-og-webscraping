...
## Deskriptiv statistikk - basefunksjoner i R {.flexbox .vleft .extraspace}
...
## Logistisk regresjon i R {.flexbox .vleft}
...
Eksempeldatasett hentet fra pakken `ISLR` {.flexbox .vleft}

* `default`: en faktorvariabel for om gjelden er misligholdt eller ikke (vår _avhengige_ variabel)
