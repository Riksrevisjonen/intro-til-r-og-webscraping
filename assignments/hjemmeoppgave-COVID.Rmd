...
5. **Visualisere**
- Bruk aggregate-funksjonen for å aggregere data på samme måte som i kodesnutten under, men for gjennomsnittet av `new_cases`
- Gjør så det samme som over, men for det nye datasettet
